...
<%  String detallePage ="";
	if (Globals.esModoRelease()) {
		detallePage  = "/contenidosEstaticos/articulos/" + ((int)Math.floor(articulo.getIdArticulo()/1000) * 1000) + "/indiceDeContenidos" + articulo.getIdArticulo() + ".html";
	} else {
		detallePage  = "/articulo/componentes/indiceDeContenidos.jsp?idArticulo=" + articulo.getIdArticulo() + "&idSeccion=" + articulo.getIdSeccion() + "&idAutor=" + idAutor;
	}
%>
