...
<%  String detallePage ="";
	if (Globals.esModoRelease()) {
		detallePage  = "/contenidosEstaticos/articulos/" + ((int)Math.floor(articulo.getIdArticulo()/1000) * 1000) + "/entrevista" + articulo.getIdArticulo() + ".html";
	} else {
		detallePage  = "/articulo/componentes/entrevista.jsp?idArticulo=" + articulo.getIdArticulo() + "&idSeccion=" + articulo.getIdSeccion();
	}
%>
