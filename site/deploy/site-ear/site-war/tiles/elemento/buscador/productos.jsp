						...
						<tr>
										...
										%>
													...
													%>
																							...
																							<%--<span class="Fprecio">Subcategoria&nbsp;</span><a href="<%=ArticuloServiceUtil.gerUrl(categoria)%>" class="Fautores"><span class="Fprecio"><%=Convert.resaltado(palabraClave, Convert.corregir(categoria.getDescripcion(), true), 0, resTxt, resTxtCie)%></span></a></td>--%>
																							<%
																								}
																							%>
																				</tr>
