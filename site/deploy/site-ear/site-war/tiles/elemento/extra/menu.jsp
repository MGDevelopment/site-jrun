    		...
    		<tr>
    			<td>
    				<table cellpadding="0" cellspacing="0">
    					<tr>
    						<td>
			    				<a name="top"></a><a href="/extra/index.jsp?seccionEXtra=1"><img src="/imagenes/fidelizacion/header_01.gif" width="202" height="90" border="0"></a>
			    			</td>
			    			<td>
			    			...
			    			<td>
				    			<a href="/extra/index.jsp?seccionEXtra=8"><img src="/imagenes/fidelizacion/200-b-165x90.gif" width="165" height="90" border="0"></a>
			    			</td>
			    		</tr>
			    	</table>
			    </td>
