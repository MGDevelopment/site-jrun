...
function eliminarArticuloDeLaMesa(idArticulo) {
	var url = 'param='+Math.random()+'&idArticulo='+idArticulo;
	new Ajax.Request('/EliminarArticuloDeLaMesa.do?'+url, {
			method: 'get',
			onSuccess: function(transport) {
				var obj = transport.responseText;
				$('divResultado').innerHHTML = '';
				$('divResultado').innerHHTML = obj;
			}
	});
}
function getArticulosRecomendadosMesa(idArticulo) {
	var idSeccion = $('frmBusquedaIdSeccion').value;
	var agrupacion = $('frmBusquedaAgrupacion').value;
	var filtro = $('frmBusquedaFiltro').value;
	
	var url = 'param='+Math.random()+'&idSeccion='+idSeccion+'&agrupacion='+agrupacion+'&filtro='+filtro;
	new Ajax.Request('/GetArticulosRecomendadosMesa.do?'+url, {
			method: 'get',
			onSuccess: function(transport) {
				//obtnego la respuesta y la convierto en un objeto JS
				var obj = transport.responseText;			
				$('divResultado').innerHTML = '';
				$('divResultado').innerHTML = obj;
			}
	});
}
</script>
