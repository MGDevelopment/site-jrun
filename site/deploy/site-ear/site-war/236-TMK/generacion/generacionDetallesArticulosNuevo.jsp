	...
	<table bgcolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" height="100%" width="770" >
		<tr>
			<td valign="top">
				...
				<form name="formBuscador" action="generacionDetallesArticulosNuevo.jsp" method="post">
				...
				<%if(senal==1){
					...
					if(!articulosElegidos.isEmpty()){ %>
                       ...
                       <%--  <form action="/generarDetalleArticulo.do" name="formDetallesEstaticos" method="post">--%>
                       <form action="/GenerardorArticulo" name="formDetallesEstaticos" method="post">
