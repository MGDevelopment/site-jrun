                              ...
                              <td><div align="center">
                                  <table width="355" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td valign="bottom" class="Ftexto02">Director/Autor: </td>
                                      <td colspan="2"><div align="left">
                                          <input type="text" name="<%=BuscadorHelper.POR_AUTOR%>" size="70" maxlength="70" class="ayudatext" />
                                      </div></td>
                                    </tr>
                                    <tr>
                                      <td valign="bottom" class="Ftexto02">Productora: </td>
                                      <td colspan="2"><div align="left">
                                      ...
                                      <td colspan="2"><div align="left">
                                          ...
                                          <select name="<%=BuscadorHelper.POR_CLASIFICACION_TEMATIKA%>" class="formbavanzada" onkeypress="intro(event)">
											...
											<%
												...
												Iterator grupos = grupoHome.findByCategoria(new Integer(Globals.SECCION_PELICULA)).iterator();
                                    ...
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td colspan="2"><div align="right"><input type="image" src="/imagenes/peliculas/b-buscaravanzado.gif"></div></td>
                                    </tr>
                                  </table>
                              </div></td>
                            </tr>
