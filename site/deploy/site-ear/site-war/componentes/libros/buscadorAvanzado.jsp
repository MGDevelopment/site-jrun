                              ...
                              <td><div align="center">
                                  <table width="355" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <td colspan="2"><div align="left">
                                          <select name="<%=BuscadorHelper.POR_IDIOMA%>" class="formbavanzada" onkeypress="intro(event)">
											...
											<%  for (int i = 0; i < Globals.IDIOMAS.length; i++) {
						                            ...
						                            if(idiomaDAO.getId().equalsIgnoreCase("AL")
						                            || idiomaDAO.getId().equalsIgnoreCase("ES")
						                            || idiomaDAO.getId().equalsIgnoreCase("FR")
						                            || idiomaDAO.getId().equalsIgnoreCase("IN")
						                            || idiomaDAO.getId().equalsIgnoreCase("IT")
						                            || idiomaDAO.getId().equalsIgnoreCase("PT")){
											%>
                                    ...
                                    <tr>
                                      ...
                                      <input type="image" src="/imagenes/libros/b-buscaravanzado.gif">
                                      </div></td>
                                    </tr>
                                  </table>
                              </div></td>
