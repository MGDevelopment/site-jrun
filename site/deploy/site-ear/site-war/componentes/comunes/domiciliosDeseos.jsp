...
%>
	<table  cellspacing="0" cellpadding="0" border="0" align="center" class="Ftexto02">
				 ...
				 <tr>
                 	<td colspan="2">
                		<div style="float:right; margin-bottom:10px; border:dashed 1px #CCC; padding:5px; font-size:1px;">
			                <a href="/miCuenta/?seccionMiCuenta=9&opcionMenu=2&TIPO_DOMICILIO=<%= request.getParameter("TIPO_DOMICILIO") %>&HOME=<%=home%>"><img src="/imagenes/compra/b-agregardomicilio.gif" alt="Agregar domicilio" border="0"></a>
        		        </div>
                	</td>
	             </tr>
    	         <tr>
		...
		%>
			<%if (!URI.equalsIgnoreCase("/listaDeseos/domicilios.jsp" ) && !URI.equalsIgnoreCase("/miCuenta/index.jsp" ) ){%>
...
<%--  			<div align="left"><a href="/<%=home%>/agregarDomicilio.jsp?TIPO_DOMICILIO=<%= request.getParameter("TIPO_DOMICILIO") %>&HOME=<%=home%>"><img src="/imagenes/compra/b-agregardomicilio.gif" alt="Agregar domicilio" width="112" height="8" border="0" class="bagregardomicilio"  /></a></div>--%>
			<div align="left"><a href="/miCuenta/?seccionMiCuenta=9&opcionMenu=2&TIPO_DOMICILIO=<%= request.getParameter("TIPO_DOMICILIO") %>&HOME=<%=home%>"><img src="/imagenes/compra/b-agregardomicilio.gif" alt="Agregar domicilio" width="112" height="8" border="0" class="bagregardomicilio"  /></a></div>
		</td>
	</tr>
<%	}
%>
