...
<!-- Fidelizacion -->        
    <tr>
      <td class="Glogin01"><a class="Flogin" href="/institucional/sucursales.jsp?sucursal=205&unegocio=ateneo"><img src="/imagenes/<%=Globals.seccion(idSeccion)%>/login/sucursales.gif" width="64" height="8" border="0" /><img class="espacioizquierda" src="/imagenes/<%=Globals.seccion(idSeccion)%>/login/miscelanea.gif" width="9" height="8" border="0" /></a></td>
    </tr>
</table>