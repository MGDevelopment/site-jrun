...
/**
 * SnpCategFamiliasId generated by hbm2java
 */
public class SnpCategFamiliasId  implements java.io.Serializable {
    ...
    public SnpCategFamiliasId() {
    }

	
    public SnpCategFamiliasId(byte categoriaSeccion, byte categoriaGrupo, byte categoriaFamilia, String descripcion, String usrAlta, Date FAlta) {
    ...
    public SnpCategFamiliasId(byte categoriaSeccion, byte categoriaGrupo, byte categoriaFamilia, String descripcion, String observaciones, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.categoriaSeccion = categoriaSeccion;
       this.categoriaGrupo = categoriaGrupo;
       this.categoriaFamilia = categoriaFamilia;
       this.descripcion = descripcion;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpCategFamiliasId) ) return false;
		 SnpCategFamiliasId castOther = ( SnpCategFamiliasId ) other; 
