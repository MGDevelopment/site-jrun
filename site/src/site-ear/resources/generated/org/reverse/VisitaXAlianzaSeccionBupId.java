...
/**
 * VisitaXAlianzaSeccionBupId generated by hbm2java
 */
public class VisitaXAlianzaSeccionBupId  implements java.io.Serializable {


     private Date fechaVisita;
     private Long idAlianza;
     private Long idSeccion;
     private short cantVisitas;
     private Date FAlta;
     private Date FModi;

    public VisitaXAlianzaSeccionBupId() {
    }

	
    public VisitaXAlianzaSeccionBupId(Date fechaVisita, short cantVisitas) {
        this.fechaVisita = fechaVisita;
        this.cantVisitas = cantVisitas;
    }
    public VisitaXAlianzaSeccionBupId(Date fechaVisita, Long idAlianza, Long idSeccion, short cantVisitas, Date FAlta, Date FModi) {
       this.fechaVisita = fechaVisita;
    ...
    public short getCantVisitas() {
        return this.cantVisitas;
    }
    
    public void setCantVisitas(short cantVisitas) {
        this.cantVisitas = cantVisitas;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VisitaXAlianzaSeccionBupId) ) return false;
		 VisitaXAlianzaSeccionBupId castOther = ( VisitaXAlianzaSeccionBupId ) other; 
