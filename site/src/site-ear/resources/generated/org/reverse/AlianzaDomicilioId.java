...
/**
 * AlianzaDomicilioId generated by hbm2java
 */
public class AlianzaDomicilioId  implements java.io.Serializable {


     private long idAlianza;
     private String tipoDomicilio;

    public AlianzaDomicilioId() {
    }

    public AlianzaDomicilioId(long idAlianza, String tipoDomicilio) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AlianzaDomicilioId) ) return false;
		 AlianzaDomicilioId castOther = ( AlianzaDomicilioId ) other; 
