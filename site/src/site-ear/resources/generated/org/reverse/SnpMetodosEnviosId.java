...
/**
 * SnpMetodosEnviosId generated by hbm2java
 */
public class SnpMetodosEnviosId  implements java.io.Serializable {
    ...
    public SnpMetodosEnviosId() {
    }

	
    public SnpMetodosEnviosId(short idMetodoEnvio, String descripcion, String habilitado, String usrAlta, Date FAlta) {
    ...
    public SnpMetodosEnviosId(short idMetodoEnvio, String descripcion, String url, String habilitado, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.idMetodoEnvio = idMetodoEnvio;
       this.descripcion = descripcion;
       this.url = url;
       this.habilitado = habilitado;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpMetodosEnviosId) ) return false;
		 SnpMetodosEnviosId castOther = ( SnpMetodosEnviosId ) other; 
         
		 return (this.getIdMetodoEnvio()==castOther.getIdMetodoEnvio())
