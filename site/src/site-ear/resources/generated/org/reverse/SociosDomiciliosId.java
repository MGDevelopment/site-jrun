...
/**
 * SociosDomiciliosId generated by hbm2java
 */
public class SociosDomiciliosId  implements java.io.Serializable {
    ...
    public SociosDomiciliosId() {
    }

    public SociosDomiciliosId(short idSucursal, long idSocio, String tipoDomicilio) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SociosDomiciliosId) ) return false;
		 SociosDomiciliosId castOther = ( SociosDomiciliosId ) other; 
