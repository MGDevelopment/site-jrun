...
/**
 * SnpLocalidId generated by hbm2java
 */
public class SnpLocalidId  implements java.io.Serializable {
    ...
    public SnpLocalidId(int idPais, int idProvincia, int idLocalidad, String descripcion, String usrAlta, Date FAlta) {
        this.idPais = idPais;
    ...
    public SnpLocalidId(int idPais, int idProvincia, int idLocalidad, String descripcion, String usrAlta, Date FAlta, String usrModi, Date FModi, Long idUsrAlta, Long idUsrModi, String gemPaisCodigo, String gemProvCodigo, String gemCiuCodigo, String habilitadoTematika) {
       this.idPais = idPais;
       this.idProvincia = idProvincia;
       this.idLocalidad = idLocalidad;
       this.descripcion = descripcion;
       ...
       this.gemCiuCodigo = gemCiuCodigo;
    ...
    public String getGemCiuCodigo() {
        return this.gemCiuCodigo;
    }
    
    public void setGemCiuCodigo(String gemCiuCodigo) {
        this.gemCiuCodigo = gemCiuCodigo;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpLocalidId) ) return false;
		 SnpLocalidId castOther = ( SnpLocalidId ) other; 
 ...
 && ( (this.getGemCiuCodigo()==castOther.getGemCiuCodigo()) || ( this.getGemCiuCodigo()!=null && castOther.getGemCiuCodigo()!=null && this.getGemCiuCodigo().equals(castOther.getGemCiuCodigo()) ) )
 && ( (this.getHabilitadoTematika()==castOther.getHabilitadoTematika()) || ( this.getHabilitadoTematika()!=null && castOther.getHabilitadoTematika()!=null && this.getHabilitadoTematika().equals(castOther.getHabilitadoTematika()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getGemCiuCodigo() == null ? 0 : this.getGemCiuCodigo().hashCode() );
