...
/**
 * BufferFdnFormulariosBup generated by hbm2java
 */
public class BufferFdnFormulariosBup  implements java.io.Serializable {
    ...
    public BufferFdnFormulariosBup() {
    }

	
    public BufferFdnFormulariosBup(String nroFormulario, Date fecha, String datosAdicionales, String usrAlta, Date FAlta) {
    ...
    public BufferFdnFormulariosBup(String nroFormulario, Date fecha, String datosAdicionales, String usrAlta, Date FAlta, String usrModi, Date FModi, Date fechaTransmision, Integer dperCodigo) {
       this.nroFormulario = nroFormulario;
       this.fecha = fecha;
       this.datosAdicionales = datosAdicionales;
       this.usrAlta = usrAlta;
