...
/**
 * SnpCategSeccione2Id generated by hbm2java
 */
public class SnpCategSeccione2Id  implements java.io.Serializable {
    ...
    public SnpCategSeccione2Id() {
    }

	
    public SnpCategSeccione2Id(byte categoriaSeccion, String descripcion, String usrAlta, Date FAlta) {
        this.categoriaSeccion = categoriaSeccion;
        this.descripcion = descripcion;
        this.usrAlta = usrAlta;
        this.FAlta = FAlta;
    }
    public SnpCategSeccione2Id(byte categoriaSeccion, String descripcion, String observaciones, String usrAlta, Date FAlta, String usrModi, Date FModi, Integer dperCodigo, Short mesesRotacion, String pricing) {
       this.categoriaSeccion = categoriaSeccion;
       this.descripcion = descripcion;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpCategSeccione2Id) ) return false;
		 SnpCategSeccione2Id castOther = ( SnpCategSeccione2Id ) other; 
