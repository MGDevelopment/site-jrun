...
/**
 * BufferSociosDomiciliosBId generated by hbm2java
 */
public class BufferSociosDomiciliosBId  implements java.io.Serializable {
    ...
    public BufferSociosDomiciliosBId() {
    }

    public BufferSociosDomiciliosBId(short idSucursal, long idSocio, String tipoDomicilio) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BufferSociosDomiciliosBId) ) return false;
		 BufferSociosDomiciliosBId castOther = ( BufferSociosDomiciliosBId ) other; 
