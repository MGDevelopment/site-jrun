...
/**
 * Dr.snpArtTemMus2Ctx.iId generated by hbm2java
 */
public class Dr.snpArtTemMus2Ctx.iId  implements java.io.Serializable {
    ...
    public Dr.snpArtTemMus2Ctx.iId() {
    }

    public Dr.snpArtTemMus2Ctx.iId(String dr$token, short dr$tokenType, Serializable dr$rowid, byte[] dr$tokenInfo) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Dr.snpArtTemMus2Ctx.iId) ) return false;
		 Dr.snpArtTemMus2Ctx.iId castOther = ( Dr.snpArtTemMus2Ctx.iId ) other; 
