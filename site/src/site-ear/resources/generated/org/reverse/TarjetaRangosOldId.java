...
/**
 * TarjetaRangosOldId generated by hbm2java
 */
public class TarjetaRangosOldId  implements java.io.Serializable {
    ...
    public TarjetaRangosOldId() {
    }

	
    public TarjetaRangosOldId(String idMedioCobro, String nroDesde, String permiteOffline, String permiteCuotas, String usrAlta, Date FAlta) {
    ...
    public TarjetaRangosOldId(String idMedioCobro, String nroDesde, String nroHasta, String permiteOffline, String permiteCuotas, String usrAlta, Date FAlta, String usrModi, Date FModi, BigDecimal longitud, String validaDigVerific, Long idBanco, Integer idPais, String categTarjeta) {
       this.idMedioCobro = idMedioCobro;
       this.nroDesde = nroDesde;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TarjetaRangosOldId) ) return false;
		 TarjetaRangosOldId castOther = ( TarjetaRangosOldId ) other; 
