...
/**
 * SnpPromoDetalleId generated by hbm2java
 */
public class SnpPromoDetalleId  implements java.io.Serializable {
    ...
    public SnpPromoDetalleId() {
    }

	
    public SnpPromoDetalleId(long idPromocion, short item, String usrAlta, Date FAlta) {
        this.idPromocion = idPromocion;
        this.item = item;
        this.usrAlta = usrAlta;
        this.FAlta = FAlta;
    }
    public SnpPromoDetalleId(long idPromocion, short item, Byte categoriaSeccion, Byte categoriaGrupo, Byte categoriaFamilia, Byte categoriaSubfamilia, Long idProveedor, Long idEditor, Long idColeccion, Long idArticulo, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.idPromocion = idPromocion;
       this.item = item;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpPromoDetalleId) ) return false;
		 SnpPromoDetalleId castOther = ( SnpPromoDetalleId ) other; 
