...
/**
 * SociosRefCodesBupId generated by hbm2java
 */
public class SociosRefCodesBupId  implements java.io.Serializable {
    ...
    public SociosRefCodesBupId() {
    }

    public SociosRefCodesBupId(long idSocio, String domain, String lowValue, short idSucursal) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SociosRefCodesBupId) ) return false;
		 SociosRefCodesBupId castOther = ( SociosRefCodesBupId ) other; 
