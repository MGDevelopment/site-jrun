...
/**
 * CarritoCompraBupId generated by hbm2java
 */
public class CarritoCompraBupId  implements java.io.Serializable {
    ...
    public CarritoCompraBupId() {
    }

    public CarritoCompraBupId(short idSucursalSocio, long idSocio, long idArticulo) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CarritoCompraBupId) ) return false;
		 CarritoCompraBupId castOther = ( CarritoCompraBupId ) other; 
