...
/**
 * SnpFdnCatalogosId generated by hbm2java
 */
public class SnpFdnCatalogosId  implements java.io.Serializable {
    ...
    public SnpFdnCatalogosId() {
    }

	
    public SnpFdnCatalogosId(int idCatalogo, String descripcion, String idCategoria, String habilitado, String usrAlta, Date FAlta) {
    ...
    public SnpFdnCatalogosId(int idCatalogo, String descripcion, String idCategoria, String habilitado, Date habilitadoFecha, String habilitadoUsr, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.idCatalogo = idCatalogo;
       this.descripcion = descripcion;
       this.idCategoria = idCategoria;
       this.habilitado = habilitado;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpFdnCatalogosId) ) return false;
		 SnpFdnCatalogosId castOther = ( SnpFdnCatalogosId ) other; 
