...
/**
 * SociosTmkDelId generated by hbm2java
 */
public class SociosTmkDelId  implements java.io.Serializable {
    ...
    public SociosTmkDelId() {
    }

    public SociosTmkDelId(Short idSucursal, Long idSocio, Date fechaBorrado) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SociosTmkDelId) ) return false;
		 SociosTmkDelId castOther = ( SociosTmkDelId ) other; 
