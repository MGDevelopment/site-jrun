...
/**
 * SnpItemsCatalogosId generated by hbm2java
 */
public class SnpItemsCatalogosId  implements java.io.Serializable {
    ...
    public SnpItemsCatalogosId() {
    }

	
    public SnpItemsCatalogosId(int idCatalogo, long idArticulo, int puntos, BigDecimal importeAdicional, Date fechaVigencia, String habilitado, String hastaStkCero, String usrAlta, Date FAlta) {
    ...
    public SnpItemsCatalogosId(int idCatalogo, long idArticulo, int puntos, BigDecimal importeAdicional, Date fechaVigencia, String habilitado, Date habilitadoFecha, String habilitadoUsr, String hastaStkCero, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.idCatalogo = idCatalogo;
       this.idArticulo = idArticulo;
       this.puntos = puntos;
       this.importeAdicional = importeAdicional;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpItemsCatalogosId) ) return false;
		 SnpItemsCatalogosId castOther = ( SnpItemsCatalogosId ) other; 
