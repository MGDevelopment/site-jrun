...
/**
 * SnpCategGruposId generated by hbm2java
 */
public class SnpCategGruposId  implements java.io.Serializable {
    ...
    public SnpCategGruposId() {
    }

	
    public SnpCategGruposId(byte categoriaSeccion, byte categoriaGrupo, String descripcion, String usrAlta, Date FAlta) {
    ...
    public SnpCategGruposId(byte categoriaSeccion, byte categoriaGrupo, String descripcion, String observaciones, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.categoriaSeccion = categoriaSeccion;
       this.categoriaGrupo = categoriaGrupo;
       this.descripcion = descripcion;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpCategGruposId) ) return false;
		 SnpCategGruposId castOther = ( SnpCategGruposId ) other; 
