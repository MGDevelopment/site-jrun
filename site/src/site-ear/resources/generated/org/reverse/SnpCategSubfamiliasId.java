...
/**
 * SnpCategSubfamiliasId generated by hbm2java
 */
public class SnpCategSubfamiliasId  implements java.io.Serializable {
    ...
    public SnpCategSubfamiliasId() {
    }

	
    public SnpCategSubfamiliasId(byte categoriaSeccion, byte categoriaGrupo, byte categoriaFamilia, byte categoriaSubfamilia, String descripcion, String usrAlta, Date FAlta) {
    ...
    public SnpCategSubfamiliasId(byte categoriaSeccion, byte categoriaGrupo, byte categoriaFamilia, byte categoriaSubfamilia, String descripcion, String observaciones, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.categoriaSeccion = categoriaSeccion;
       this.categoriaGrupo = categoriaGrupo;
       this.categoriaFamilia = categoriaFamilia;
       this.categoriaSubfamilia = categoriaSubfamilia;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpCategSubfamiliasId) ) return false;
		 SnpCategSubfamiliasId castOther = ( SnpCategSubfamiliasId ) other; 
