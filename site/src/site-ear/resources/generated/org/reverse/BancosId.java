...
/**
 * BancosId generated by hbm2java
 */
public class BancosId  implements java.io.Serializable {
    ...
    public BancosId(int idBanco, String descripcion, Date FAlta, String usrAlta) {
        this.idBanco = idBanco;
        this.descripcion = descripcion;
        this.FAlta = FAlta;
        this.usrAlta = usrAlta;
    }
    public BancosId(int idBanco, String descripcion, Date FAlta, String usrAlta, Date FModi, String usrModi) {
       this.idBanco = idBanco;
       this.descripcion = descripcion;
       this.FAlta = FAlta;
       this.usrAlta = usrAlta;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BancosId) ) return false;
