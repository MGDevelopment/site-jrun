...
/**
 * SnpCategFamilias2Id generated by hbm2java
 */
public class SnpCategFamilias2Id  implements java.io.Serializable {
    ...
    public SnpCategFamilias2Id() {
    }

	
    public SnpCategFamilias2Id(byte categoriaSeccion, byte categoriaGrupo, byte categoriaFamilia, String descripcion, String usrAlta, Date FAlta) {
    ...
    public SnpCategFamilias2Id(byte categoriaSeccion, byte categoriaGrupo, byte categoriaFamilia, String descripcion, String observaciones, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.categoriaSeccion = categoriaSeccion;
       this.categoriaGrupo = categoriaGrupo;
       this.categoriaFamilia = categoriaFamilia;
       this.descripcion = descripcion;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpCategFamilias2Id) ) return false;
		 SnpCategFamilias2Id castOther = ( SnpCategFamilias2Id ) other; 
