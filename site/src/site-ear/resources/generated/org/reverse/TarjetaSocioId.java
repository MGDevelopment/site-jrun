...
/**
 * TarjetaSocioId generated by hbm2java
 */
public class TarjetaSocioId  implements java.io.Serializable {
    ...
    public TarjetaSocioId() {
    }

    public TarjetaSocioId(short idSucursalSocio, long idSocio, BigDecimal idItem) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TarjetaSocioId) ) return false;
		 TarjetaSocioId castOther = ( TarjetaSocioId ) other; 
