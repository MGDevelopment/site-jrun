...
/**
 * SociosTmkId generated by hbm2java
 */
public class SociosTmkId  implements java.io.Serializable {
    ...
    public SociosTmkId(short idSucursal, long idSocio) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SociosTmkId) ) return false;
		 SociosTmkId castOther = ( SociosTmkId ) other; 
