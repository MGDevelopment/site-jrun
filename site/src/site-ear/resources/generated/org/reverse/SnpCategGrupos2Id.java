...
/**
 * SnpCategGrupos2Id generated by hbm2java
 */
public class SnpCategGrupos2Id  implements java.io.Serializable {
    ...
    public SnpCategGrupos2Id() {
    }

	
    public SnpCategGrupos2Id(byte categoriaSeccion, byte categoriaGrupo, String descripcion, String usrAlta, Date FAlta) {
    ...
    public SnpCategGrupos2Id(byte categoriaSeccion, byte categoriaGrupo, String descripcion, String observaciones, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.categoriaSeccion = categoriaSeccion;
       this.categoriaGrupo = categoriaGrupo;
       this.descripcion = descripcion;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpCategGrupos2Id) ) return false;
		 SnpCategGrupos2Id castOther = ( SnpCategGrupos2Id ) other; 
