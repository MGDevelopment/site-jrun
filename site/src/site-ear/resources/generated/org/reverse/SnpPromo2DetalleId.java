...
/**
 * SnpPromo2DetalleId generated by hbm2java
 */
public class SnpPromo2DetalleId  implements java.io.Serializable {
    ...
    public SnpPromo2DetalleId() {
    }

	
    public SnpPromo2DetalleId(long idPromocion, short item, String incluirExcluir, String usrAlta, Date FAlta) {
    ...
    public SnpPromo2DetalleId(long idPromocion, short item, String incluirExcluir, Byte categoriaSeccion, Byte categoriaGrupo, Byte categoriaFamilia, Byte categoriaSubfamilia, Long idProveedor, Long idEditor, Long idColeccion, Long idArticulo, Integer idCatalogo, Long idAutor, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.idPromocion = idPromocion;
       this.item = item;
       this.incluirExcluir = incluirExcluir;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpPromo2DetalleId) ) return false;
		 SnpPromo2DetalleId castOther = ( SnpPromo2DetalleId ) other; 
