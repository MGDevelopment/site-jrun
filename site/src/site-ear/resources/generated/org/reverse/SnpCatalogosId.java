...
/**
 * SnpCatalogosId generated by hbm2java
 */
public class SnpCatalogosId  implements java.io.Serializable {
    ...
    public SnpCatalogosId() {
    }

	
    public SnpCatalogosId(int idCatalogo, String descripcion, String idCategoria, String habilitado, String usrAlta, Date FAlta) {
    ...
    public SnpCatalogosId(int idCatalogo, String descripcion, String idCategoria, String habilitado, Date habilitadoFecha, String habilitadoUsr, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.idCatalogo = idCatalogo;
       this.descripcion = descripcion;
       this.idCategoria = idCategoria;
       this.habilitado = habilitado;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpCatalogosId) ) return false;
		 SnpCatalogosId castOther = ( SnpCatalogosId ) other; 
