...
/**
 * BufferFdnTarjetasXCuentasbId generated by hbm2java
 */
public class BufferFdnTarjetasXCuentasbId  implements java.io.Serializable {
    ...
    public BufferFdnTarjetasXCuentasbId() {
    }

	
    public BufferFdnTarjetasXCuentasbId(String nroTarjeta, long idCuenta, short idSucursalCuenta, String usrAlta, Date FAlta) {
    ...
    public BufferFdnTarjetasXCuentasbId(String nroTarjeta, long idCuenta, short idSucursalCuenta, Byte idCuso, Date fechaTransmision, String usrAlta, Date FAlta, String usrModi, Date FModi, String nroFormulario) {
       this.nroTarjeta = nroTarjeta;
       this.idCuenta = idCuenta;
       this.idSucursalCuenta = idSucursalCuenta;
       this.idCuso = idCuso;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BufferFdnTarjetasXCuentasbId) ) return false;
		 BufferFdnTarjetasXCuentasbId castOther = ( BufferFdnTarjetasXCuentasbId ) other; 
