...
/**
 * BufferFdnTarjetas generated by hbm2java
 */
public class BufferFdnTarjetas  implements java.io.Serializable {
    ...
    public BufferFdnTarjetas() {
    }

	
    public BufferFdnTarjetas(String nroTarjeta, String estado, String usrAlta, Date FAlta) {
        this.nroTarjeta = nroTarjeta;
        this.estado = estado;
        this.usrAlta = usrAlta;
        this.FAlta = FAlta;
    }
    public BufferFdnTarjetas(String nroTarjeta, String estado, Date estadoFecha, String estadoUsr, Date fechaTransmision, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.nroTarjeta = nroTarjeta;
       this.estado = estado;
