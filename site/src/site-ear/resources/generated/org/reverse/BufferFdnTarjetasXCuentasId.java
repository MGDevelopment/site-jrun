...
/**
 * BufferFdnTarjetasXCuentasId generated by hbm2java
 */
public class BufferFdnTarjetasXCuentasId  implements java.io.Serializable {
    ...
    public BufferFdnTarjetasXCuentasId() {
    }

	
    public BufferFdnTarjetasXCuentasId(String nroTarjeta, long idCuenta, short idSucursalCuenta, String usrAlta, Date FAlta) {
    ...
    public BufferFdnTarjetasXCuentasId(String nroTarjeta, long idCuenta, short idSucursalCuenta, Byte idCuso, Date fechaTransmision, String usrAlta, Date FAlta, String usrModi, Date FModi, String nroFormulario) {
       this.nroTarjeta = nroTarjeta;
       this.idCuenta = idCuenta;
       this.idSucursalCuenta = idSucursalCuenta;
       this.idCuso = idCuso;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BufferFdnTarjetasXCuentasId) ) return false;
		 BufferFdnTarjetasXCuentasId castOther = ( BufferFdnTarjetasXCuentasId ) other; 
