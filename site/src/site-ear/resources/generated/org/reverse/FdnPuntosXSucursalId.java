...
/**
 * FdnPuntosXSucursalId generated by hbm2java
 */
public class FdnPuntosXSucursalId  implements java.io.Serializable {
    ...
    public FdnPuntosXSucursalId() {
    }

    public FdnPuntosXSucursalId(long idCuenta, Date mes, short idSucursalCuenta, short idSucursal) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FdnPuntosXSucursalId) ) return false;
		 FdnPuntosXSucursalId castOther = ( FdnPuntosXSucursalId ) other; 
