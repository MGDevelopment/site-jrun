...
/**
 * SnpItemsCatalogos3Id generated by hbm2java
 */
public class SnpItemsCatalogos3Id  implements java.io.Serializable {
    ...
    public SnpItemsCatalogos3Id() {
    }

	
    public SnpItemsCatalogos3Id(int idCatalogo, long idArticulo, int puntos, BigDecimal importeAdicional, Date fechaVigencia, String habilitado, String hastaStkCero, String usrAlta, Date FAlta, int item, String muestraTmk) {
    ...
    public SnpItemsCatalogos3Id(int idCatalogo, long idArticulo, int puntos, BigDecimal importeAdicional, Date fechaVigencia, String habilitado, Date habilitadoFecha, String habilitadoUsr, String hastaStkCero, String usrAlta, Date FAlta, String usrModi, Date FModi, int item, String muestraTmk) {
       this.idCatalogo = idCatalogo;
       this.idArticulo = idArticulo;
       this.puntos = puntos;
       this.importeAdicional = importeAdicional;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpItemsCatalogos3Id) ) return false;
		 SnpItemsCatalogos3Id castOther = ( SnpItemsCatalogos3Id ) other; 
 ...
 && ( (this.getMuestraTmk()==castOther.getMuestraTmk()) || ( this.getMuestraTmk()!=null && castOther.getMuestraTmk()!=null && this.getMuestraTmk().equals(castOther.getMuestraTmk()) ) );
   }
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getMuestraTmk() == null ? 0 : this.getMuestraTmk().hashCode() );
         return result;
   }   
