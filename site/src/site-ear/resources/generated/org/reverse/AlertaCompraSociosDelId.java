...
/**
 * AlertaCompraSociosDelId generated by hbm2java
 */
public class AlertaCompraSociosDelId  implements java.io.Serializable {
    ...
    public AlertaCompraSociosDelId() {
    }

    public AlertaCompraSociosDelId(Short idSucursal, Long idSocio, Date fechaBorrado) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AlertaCompraSociosDelId) ) return false;
		 AlertaCompraSociosDelId castOther = ( AlertaCompraSociosDelId ) other; 
