...
/**
 * SnpFdnPuntosXSucursalId generated by hbm2java
 */
public class SnpFdnPuntosXSucursalId  implements java.io.Serializable {
    ...
    public SnpFdnPuntosXSucursalId() {
    }

    public SnpFdnPuntosXSucursalId(long idCuenta, Date mes, short idSucursalCuenta, short idSucursal) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpFdnPuntosXSucursalId) ) return false;
		 SnpFdnPuntosXSucursalId castOther = ( SnpFdnPuntosXSucursalId ) other; 
