...
/**
 * CarritoListaDeseosBupId generated by hbm2java
 */
public class CarritoListaDeseosBupId  implements java.io.Serializable {
    ...
    public CarritoListaDeseosBupId() {
    }

    public CarritoListaDeseosBupId(short idSucursalSocio, long idSocio, BigDecimal idArticulo) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CarritoListaDeseosBupId) ) return false;
		 CarritoListaDeseosBupId castOther = ( CarritoListaDeseosBupId ) other; 
