...
/**
 * SociosTelefonosDelId generated by hbm2java
 */
public class SociosTelefonosDelId  implements java.io.Serializable {
    ...
    public SociosTelefonosDelId() {
    }

    public SociosTelefonosDelId(Short idSucursal, Long idSocio, String tipoTelefono, Date fechaBorrado) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SociosTelefonosDelId) ) return false;
		 SociosTelefonosDelId castOther = ( SociosTelefonosDelId ) other; 
