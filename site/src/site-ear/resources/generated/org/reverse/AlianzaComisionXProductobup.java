...
/**
 * AlianzaComisionXProductobup generated by hbm2java
 */
public class AlianzaComisionXProductobup  implements java.io.Serializable {
    ...
    public AlianzaComisionXProductobup() {
    }

	
    public AlianzaComisionXProductobup(byte categoriaSeccion, BigDecimal porcComision) {
        this.categoriaSeccion = categoriaSeccion;
        this.porcComision = porcComision;
    }
    public AlianzaComisionXProductobup(byte categoriaSeccion, BigDecimal porcComision, Date FAlta, Date FModi) {
       this.categoriaSeccion = categoriaSeccion;
       this.porcComision = porcComision;
       this.FAlta = FAlta;
       this.FModi = FModi;
