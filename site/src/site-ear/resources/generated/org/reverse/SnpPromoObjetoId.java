...
/**
 * SnpPromoObjetoId generated by hbm2java
 */
public class SnpPromoObjetoId  implements java.io.Serializable {
    ...
    public SnpPromoObjetoId() {
    }

	
    public SnpPromoObjetoId(long idPromocion, short item, String usrAlta, Date FAlta) {
        this.idPromocion = idPromocion;
        this.item = item;
        this.usrAlta = usrAlta;
        this.FAlta = FAlta;
    }
    public SnpPromoObjetoId(long idPromocion, short item, Byte categoriaSeccion, Byte categoriaGrupo, Byte categoriaFamilia, Byte categoriaSubfamilia, Long idProveedor, Long idEditor, Long idColeccion, Long idArticulo, Short cantidad, BigDecimal monto, String usrAlta, Date FAlta, String usrModi, Date FModi) {
       this.idPromocion = idPromocion;
       this.item = item;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpPromoObjetoId) ) return false;
		 SnpPromoObjetoId castOther = ( SnpPromoObjetoId ) other; 
