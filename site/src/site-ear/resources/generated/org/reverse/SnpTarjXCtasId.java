...
/**
 * SnpTarjXCtasId generated by hbm2java
 */
public class SnpTarjXCtasId  implements java.io.Serializable {
    ...
    public SnpTarjXCtasId() {
    }

	
    public SnpTarjXCtasId(String nroTarjeta, long idCuenta, short idSucursalCuenta, String usrAlta, Date FAlta) {
    ...
    public SnpTarjXCtasId(String nroTarjeta, long idCuenta, short idSucursalCuenta, Byte idCuso, String usrAlta, Date FAlta, String usrModi, Date FModi, String nroFormulario) {
       this.nroTarjeta = nroTarjeta;
       this.idCuenta = idCuenta;
       this.idSucursalCuenta = idSucursalCuenta;
       this.idCuso = idCuso;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpTarjXCtasId) ) return false;
		 SnpTarjXCtasId castOther = ( SnpTarjXCtasId ) other; 
