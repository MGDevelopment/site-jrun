...
/**
 * SociosVehiculosId generated by hbm2java
 */
public class SociosVehiculosId  implements java.io.Serializable {
    ...
    public SociosVehiculosId() {
    }

    public SociosVehiculosId(long idSocio, byte idSovh, short idSucursal) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SociosVehiculosId) ) return false;
		 SociosVehiculosId castOther = ( SociosVehiculosId ) other; 
