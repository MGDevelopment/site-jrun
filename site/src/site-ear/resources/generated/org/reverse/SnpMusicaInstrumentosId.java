...
/**
 * SnpMusicaInstrumentosId generated by hbm2java
 */
public class SnpMusicaInstrumentosId  implements java.io.Serializable {
    ...
    public SnpMusicaInstrumentosId() {
    }

	
    public SnpMusicaInstrumentosId(long idInstrumento, String nombre, Date FAlta, String usrAlta) {
        this.idInstrumento = idInstrumento;
        this.nombre = nombre;
        this.FAlta = FAlta;
        this.usrAlta = usrAlta;
    }
    public SnpMusicaInstrumentosId(long idInstrumento, String nombre, Date FAlta, String usrAlta, Date FModi, String usrModi) {
       this.idInstrumento = idInstrumento;
       this.nombre = nombre;
       this.FAlta = FAlta;
       this.usrAlta = usrAlta;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SnpMusicaInstrumentosId) ) return false;
		 SnpMusicaInstrumentosId castOther = ( SnpMusicaInstrumentosId ) other; 
         
		 return (this.getIdInstrumento()==castOther.getIdInstrumento())
