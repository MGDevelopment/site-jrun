...
/**
 * Class AlertaRegistracionConDocDuplicado.
 * 
 * @version $Revision$ $Date$
 */
public class AlertaRegistracionConDocDuplicado implements java.io.Serializable {
    ...
    public AlertaRegistracionConDocDuplicado() {
        super();
        _emailList = new Vector();
    } //-- com.tmk.kernel.site.AlertaRegistracionConDocDuplicado()
     ...
     * @param reader
     */
    public static com.tmk.kernel.site.AlertaRegistracionConDocDuplicado unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.tmk.kernel.site.AlertaRegistracionConDocDuplicado) Unmarshaller.unmarshal(com.tmk.kernel.site.AlertaRegistracionConDocDuplicado.class, reader);
    } //-- com.tmk.kernel.site.AlertaRegistracionConDocDuplicado unmarshal(java.io.Reader) 
