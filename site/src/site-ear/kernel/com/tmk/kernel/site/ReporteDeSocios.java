...
/**
 * Class ReporteDeSocios.
 * 
 * @version $Revision$ $Date$
 */
public class ReporteDeSocios implements java.io.Serializable {
    ...
    public ReporteDeSocios() {
        super();
        _emailList = new Vector();
    } //-- com.tmk.kernel.site.ReporteDeSocios()
     ...
     * @param reader
     */
    public static com.tmk.kernel.site.ReporteDeSocios unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.tmk.kernel.site.ReporteDeSocios) Unmarshaller.unmarshal(com.tmk.kernel.site.ReporteDeSocios.class, reader);
    } //-- com.tmk.kernel.site.ReporteDeSocios unmarshal(java.io.Reader) 
