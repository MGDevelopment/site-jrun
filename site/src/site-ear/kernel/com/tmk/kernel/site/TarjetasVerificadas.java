...
/**
 * Class TarjetasVerificadas.
 * 
 * @version $Revision$ $Date$
 */
public class TarjetasVerificadas implements java.io.Serializable {
    ...
    public TarjetasVerificadas() {
        super();
        _emailList = new Vector();
    } //-- com.tmk.kernel.site.TarjetasVerificadas()
     ...
     * @param reader
     */
    public static com.tmk.kernel.site.TarjetasVerificadas unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.tmk.kernel.site.TarjetasVerificadas) Unmarshaller.unmarshal(com.tmk.kernel.site.TarjetasVerificadas.class, reader);
    } //-- com.tmk.kernel.site.TarjetasVerificadas unmarshal(java.io.Reader) 
