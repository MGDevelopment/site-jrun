...
/**
 * Class RecorridoFamiliaDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class RecorridoFamiliaDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RecorridoFamiliaDescriptor() {
        super();
        xmlName = "RecorridoFamilia";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RecorridoFamilia target = (RecorridoFamilia) object;
                if(!target.hasId())
                    return null;
        ...
        desc.setValidator(fieldValidator);
    } //-- com.tmk.kernel.site.RecorridoFamiliaDescriptor()
    ...
    {
        return com.tmk.kernel.site.RecorridoFamilia.class;
