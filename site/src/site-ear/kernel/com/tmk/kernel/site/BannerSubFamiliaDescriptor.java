...
/**
 * Class BannerSubFamiliaDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class BannerSubFamiliaDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BannerSubFamiliaDescriptor() {
        super();
        xmlName = "BannerSubFamilia";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                BannerSubFamilia target = (BannerSubFamilia) object;
                if(!target.hasId())
                    return null;
    ...
    } //-- com.tmk.kernel.site.BannerSubFamiliaDescriptor()
    ...
    {
        return com.tmk.kernel.site.BannerSubFamilia.class;
