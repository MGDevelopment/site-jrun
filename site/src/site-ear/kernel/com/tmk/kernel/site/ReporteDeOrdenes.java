...
/**
 * Class ReporteDeOrdenes.
 * 
 * @version $Revision$ $Date$
 */
public class ReporteDeOrdenes implements java.io.Serializable {
    ...
    public ReporteDeOrdenes() {
        super();
        _emailList = new Vector();
    } //-- com.tmk.kernel.site.ReporteDeOrdenes()
     ...
     * @param reader
     */
    public static com.tmk.kernel.site.ReporteDeOrdenes unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.tmk.kernel.site.ReporteDeOrdenes) Unmarshaller.unmarshal(com.tmk.kernel.site.ReporteDeOrdenes.class, reader);
    } //-- com.tmk.kernel.site.ReporteDeOrdenes unmarshal(java.io.Reader) 
