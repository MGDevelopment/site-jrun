...
/**
 * Class ReporteDeVisitas.
 * 
 * @version $Revision$ $Date$
 */
public class ReporteDeVisitas implements java.io.Serializable {
    ...
    public ReporteDeVisitas() {
        super();
        _emailList = new Vector();
    } //-- com.tmk.kernel.site.ReporteDeVisitas()
     ...
     * @param reader
     */
    public static com.tmk.kernel.site.ReporteDeVisitas unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.tmk.kernel.site.ReporteDeVisitas) Unmarshaller.unmarshal(com.tmk.kernel.site.ReporteDeVisitas.class, reader);
    } //-- com.tmk.kernel.site.ReporteDeVisitas unmarshal(java.io.Reader) 
