...
/**
 * Class ReporteDeEstadoDeOrden.
 * 
 * @version $Revision$ $Date$
 */
public class ReporteDeEstadoDeOrden implements java.io.Serializable {
    ...
    public ReporteDeEstadoDeOrden() {
        super();
        _emailList = new Vector();
    } //-- com.tmk.kernel.site.ReporteDeEstadoDeOrden()
     ...
     * @param reader
     */
    public static com.tmk.kernel.site.ReporteDeEstadoDeOrden unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.tmk.kernel.site.ReporteDeEstadoDeOrden) Unmarshaller.unmarshal(com.tmk.kernel.site.ReporteDeEstadoDeOrden.class, reader);
    } //-- com.tmk.kernel.site.ReporteDeEstadoDeOrden unmarshal(java.io.Reader) 
