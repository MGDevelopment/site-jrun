...
/**
 * Class ReporteDeContenido.
 * 
 * @version $Revision$ $Date$
 */
public class ReporteDeContenido implements java.io.Serializable {
    ...
    public ReporteDeContenido() {
        super();
        _emailList = new Vector();
    } //-- com.tmk.kernel.site.ReporteDeContenido()
     ...
     * @param reader
     */
    public static com.tmk.kernel.site.ReporteDeContenido unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.tmk.kernel.site.ReporteDeContenido) Unmarshaller.unmarshal(com.tmk.kernel.site.ReporteDeContenido.class, reader);
    } //-- com.tmk.kernel.site.ReporteDeContenido unmarshal(java.io.Reader) 
