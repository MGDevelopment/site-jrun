              ...
              <tr>
                <td class="moduloayuda"><div align="center">
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td valign="bottom" class="Ftexto02"><span class="FTtit01">
                       
                      <%	//DETERMINO POR QUE MOTIVO NO SE REALIZO EL PAGO CORRECTAMENTE
                      		if(errorCode.toUpperCase().equals("INVALID_INPUT")) {
              			 		out.println("Los datos de entrada son inv&aacute;lidos.");
		              		}else if(errorCode.toUpperCase().equals("INVALID_TOKEN")) {
		              			out.println("Los datos del token son inv&aacute;lidos.");
		              		}else if(errorCode.toUpperCase().equals("MAXAMOUNT_EXCEEDED")) {
		              			out.println("El importe de la compra es inválido. El importe	excede el máximo definido para operar por el Sitio.");
		              		}else if(errorCode.toUpperCase().equals("SESSION_EXPIRED")) {
		              			out.println("El tiempo definido por el sitio para la sesión expiró.");
		              		}else if(errorCode.toUpperCase().equals("CANCELLED_BY_USER")) {
		              			out.println("Has cancelado la operacion. Recorda que pod&eacute;s pagar tu orden ingresando desde tu email, al link que te hemos enviado");
		              		} 
		              	%>
