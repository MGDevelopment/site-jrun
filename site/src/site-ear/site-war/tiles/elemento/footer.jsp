...
<img src="/imagenes/rediseno/imagenes/comun/rssLogo.gif" alt=""/>
...
<a onclick="window.open('http://www.yenny-elateneo.com/index.php?idS=2');return false;" href="#" >EVENTOS</a> |
<a onclick="window.open('http://www.yenny-elateneo.com/#Ranking');return false;" href="#">RANKING</a> |
...
<a href="mailto:<%=Globals.MAIL_CALL_CENTER%>">CONTACTO</a> <br />
<a href="/referido">PROGRAMA DE REFERIDOS</a> |
