...
if (Globals.esModoRelease()) {
	tagPage = "/contenidosEstaticos/articulos/" + ((int)Math.floor(articulo.getIdArticulo()/1000) * 1000) + "/tagIndice" + articulo.getIdArticulo() + ".html";
} else {
	tagPage = "/articulo/componentes/tag.jsp?idArticulo=" + articulo.getIdArticulo() + "&textoSeccion= Indice de Contenidos";
}%>
