...
<%  String detallePage ="";
	if (Globals.esModoRelease()) {
		detallePage  = "/contenidosEstaticos/articulos/" + ((int)Math.floor(articulo.getIdArticulo()/1000) * 1000) + "/primerCapitulo" + articulo.getIdArticulo() + ".html";
	} else {
		detallePage  = "/articulo/componentes/primerCapitulo.jsp?idArticulo=" + articulo.getIdArticulo() + "&idSeccion=" + articulo.getIdSeccion();
	}
%>
