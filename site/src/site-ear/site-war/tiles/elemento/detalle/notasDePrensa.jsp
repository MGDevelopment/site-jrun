...
<%  String detallePage ="";
	if (Globals.esModoRelease()) {
		detallePage  = "/contenidosEstaticos/articulos/" + ((int)Math.floor(articulo.getIdArticulo()/1000) * 1000) + "/notaPrensa" + articulo.getIdArticulo() + ".html";
	} else {
		detallePage  = "/articulo/componentes/notaPrensa.jsp?idArticulo=" + articulo.getIdArticulo() + "&idSeccion=" + articulo.getIdSeccion();
	}
%>
