...
<%  String URI = request.getRequestURI();
	//System.out.println("url de domicilios "+URI);
%>
					...
					<td valign="bottom" class="Ftexto02">
						<table width="366" border="0" cellpadding="0" cellspacing="0" class="tabladomicilios">
							<%
								...
								//debe ser solo para direccion de envio
						   ...
						   <tr>
	                             <td colspan="2"><table width="366" border="0" cellspacing="0" cellpadding="0" class="Ftexto02">
	                                 <tr>
	                                   ...
	                                   <%}else{ %>
							          <td width="61" valign="bottom"><div align="right">
							          <a href="javascript:document.getElementById('<%= domicilio.getTIPO_DOMICILIO()%>').checked=true; modificarDireccion(); ">
							          <img src="/imagenes/miCuenta/b-modificar.gif" alt="Modificar domicilio" width="60" height="10" border="0" style="padding-right:15px" />
							          </a></div></td>
	                                   <%} %>
	                                 </tr>
	                              </table></td>
...
<%-- 	                <a href="/<%=home%>/agregarDomicilio.jsp?TIPO_DOMICILIO=<%= request.getParameter("TIPO_DOMICILIO") %>&HOME=<%=home%>"><img src="/imagenes/compra/b-agregardomicilio.gif" alt="Agregar domicilio" border="0"></a>--%>
		                <a href="/<%=home%>/?seccionMiCuenta=9&opcionMenu=2&TIPO_DOMICILIO=<%= request.getParameter("TIPO_DOMICILIO") %>&HOME=<%=home%>"><img src="/imagenes/compra/b-agregardomicilio.gif" alt="Agregar domicilio" border="0"></a>
        		        </div>
                	</td>
	             </tr>
    	         <tr>
		...
		%>
			<%if ( !URI.equalsIgnoreCase("/miCuenta/domicilios.jsp" ) && !URI.equalsIgnoreCase("/miCuenta/index.jsp" ) ){%>
...
%>
	...
	<tr>
		<td align="center" class="Ftexto01">
			...
			<div align="left"><a href="/<%=home%>/?seccionMiCuenta=9&opcionMenu=2&TIPO_DOMICILIO=<%= request.getParameter("TIPO_DOMICILIO") %>&HOME=<%=home%>"><img src="/imagenes/compra/b-agregardomicilio.gif" alt="Agregar domicilio" width="112" height="8" border="0" class="bagregardomicilio"  /></a></div>
<%--             <a href="/<%=home%>/?seccionMiCuenta=9&opcionMenu=2&TIPO_DOMICILIO=<%= request.getParameter("TIPO_DOMICILIO") %>&HOME=<%=home%>"><img src="/imagenes/compra/b-agregardomicilio.gif" alt="Agregar domicilio" border="0"></a> --%>
		</td>
	</tr>
<%	}
