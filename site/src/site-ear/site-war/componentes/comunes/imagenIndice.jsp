...
<%
	...
	String txtALT = Convert.toString(request.getParameter("txtALT"), "");
...
%>	
		<a href="javascript:mostrarImagen('<%=pathImgGde%>');">
			<img src="<%=pathImgCh%>" width="<%=ancho %>" height="<%=alto %>" border="0" alt="<%=txtALT %>">
		</a><br>
		<a href="javascript:mostrarImagen('<%=pathImgGde%>');">
...
%>		
		<a href="javascript:mostrarImagen('<%=pathImgGde%>');">
			<img src="<%=pathImgGde%>" width="<%=ancho %>" height="<%=alto %>" border="0"  alt="<%=txtALT %>">
		</a><br>
		<a href="javascript:mostrarImagen('<%=pathImgGde%>');">
			Ver imagen ampliada del producto 
		</a>
...
%>
		<img src="<%=tapaGenerica%>" width="<%=ancho %>" height="<%=alto %>" border="0"  alt="<%=txtALT %>">
<%
	}
%>			
