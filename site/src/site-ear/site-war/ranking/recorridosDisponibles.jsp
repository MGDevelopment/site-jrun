...
<head>
		<%= Globals.icon() %>
		<%= Globals.charset() %>
		<%= Globals.title((idSeccion==4)?"Recorridos Disponibles de M&uacute;sica ":"Recorridos Disponibles de Pel&iacute;culas ")%>
          ...
          <tr>
            ...
            <td class="Gcentro" width="422"><table width="390" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
               	<td>
	               <%
			       String recorridoPage = "/contenidosEstaticos/homes/recorridoDisponible"+idSeccion+"_" + recorridoInicial + "_" + recorridoFinal +".html";
		    	   %>
                	<jsp:include page="<%=recorridoPage%>"/>
	            </td>
    	      </tr>				
              <tr>
                <!-- ULTIMOS VISITADOS -->
