...
<td class="Gcentro">
				...
				function plan() {
				    if(http.readyState == 4){
					    ...
					    <tr>
                    		<td align="left">
	           	            <%
		    		            String urlPage = Globals.DOMINIO_SITIO + "/detalle/entrevistas.jsp?idArticulo=" + articulo.getIdArticulo();
          ...
          <%
           	 String entrevista  = ArticuloManager.getEntrevista(idArticulo, Contenido.getServletContext());
          %>
          <% if (entrevista != null) { %>
              <tr>
                <td>
                	<table width="375" border="0" align="center" cellpadding="0" cellspacing="0" class="modulosmedioDetalle">
    		                ...
    		                <td class="titulosceldas">
    		                	<table width="375" border="0" cellpadding="0" cellspacing="0" class="titulosceldas2">
			                        <tr>
            			              <td>
            			              	<a name="titulo">
            			              		<img src="/imagenes/<%=Globals.seccion(articulo.getIdSeccion())%>/t-entrevistas.gif" alt="Entrevistas" width="85" height="10" />
            			              	</a>
           			              	  </td>
                        			</tr>
			                    </table>
	                  ...
	                  <tr>
    	                <td class="modulosinopsis">
						<span class="Ftexto06"><%=entrevista%></span></td>
            	      </tr>
				    </table>
				</td>
              </tr>
