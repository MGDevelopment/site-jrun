...
<td class="Gcentro">
				...
				function plan() {
				    if(http.readyState == 4){
					    ...
					    <tr>
                    		<td align="left">
	           	            <%
		    		            String urlPage = Globals.DOMINIO_SITIO + "/detalle/primerCapitulo.jsp?idArticulo=" + articulo.getIdArticulo();
          ...
          <%
          	String primerCapitulo = ArticuloManager.getPrimerCapitulo(idArticulo, Contenido.getServletContext());
          %>
          <% if (primerCapitulo!=null && !"".equals(primerCapitulo)) { %>
              <tr>
                <td>
                	<table width="375" border="0" align="center" cellpadding="0" cellspacing="0" class="modulosmedioDetalle">
    		                ...
    		                <td class="titulosceldas">
    		                	<table width="375" border="0" cellpadding="0" cellspacing="0" class="titulosceldas2">
			                        <tr>
            			              <td>
            			              <a name="titulo">
	            			              <img src="/imagenes/<%=Globals.seccion(articulo.getIdSeccion())%>/t-primercapitulo.gif" alt="Primer cap&iacute;tulo" width="113" height="10" />
            			              </a>
            			              </td>
                        			</tr>
			                    </table>
	                  ...
	                  <tr>
						...
						<span class="Ftexto06"><%=primerCapitulo%></span></td>
            	      </tr>
				    </table>
				</td>
              </tr>
