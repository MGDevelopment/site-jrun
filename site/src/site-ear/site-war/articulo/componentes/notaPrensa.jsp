...
<td class="Gcentro">
				...
				function plan() {
				    if(http.readyState == 4){
					    ...
					    <tr>
                    		<td align="left">
	           	            <%
		    		            String urlPage = Globals.DOMINIO_SITIO + "/detalle/notaPrensa.jsp?idArticulo=" + articulo.getIdArticulo();
          ...
          <%
          	String notaDePrensa = ArticuloManager.getNotaDePrensa(idArticulo, Contenido.getServletContext());
          %>
          <% if (notaDePrensa!=null && !"".equals(notaDePrensa)) { %>
              <tr>
                <td>
                	<table width="375" border="0" align="center" cellpadding="0" cellspacing="0" class="modulosmedioDetalle">
	                  <tr>
	               	      <td class="titulosceldasDetalle">
	               	      	<a name="titulo">
		               	    	  <img src="/imagenes/<%=Globals.seccion(articulo.getIdSeccion())%>/t-notas.gif" alt="Notas de Prensa" />
		               	    </a>
		               	  </td>
	                  </tr>
	                  <tr>
    	                <td class="modulosinopsis"><h2 class="Ftexto06"><b><%=Convert.corregir(articulo.getTitulo(), true)%> - <%=articulo.getAtributoPrincipal()%></b></h2>
						<span class="Ftexto06"><%=notaDePrensa%></span></td>
            	      </tr>
				    </table>
				</td>
              </tr>
