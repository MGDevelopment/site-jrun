		...
		<td valign="top">
			...
			<table width="80%" cellspacing="0" cellpadding="3" align="center">
				...
				<tr>
					...
					<td width="56%"><a href="nuevoUsuario.jsp"><font style=" font-family: Verdana, Arial, Helvetica, sans-serif; text-decoration:none; font-weight: bold; color: #000000; font-size:12" >Alta</font></a></td>
				</tr>
				<tr>
					<td align="right"><img src="/imagenes/clickTrans.gif"></td>
					<td><a href="eliminarUsuario.jsp " ><font style=" font-family: Verdana, Arial, Helvetica, sans-serif; text-decoration:none; font-weight: bold; color: #000000; font-size=12" >Baja</font></a></td>
				</tr>
				<tr>
					<td align="right"><img src="/imagenes/clickTrans.gif"></td>
					<td><a href="cambiarPassword.jsp " ><font style=" font-family: Verdana, Arial, Helvetica, sans-serif; text-decoration:none; font-weight: bold; color: #000000; font-size:12" >Cambiar Contraseña
					</font></a></td>
				</tr>
				<tr>
					<td height="200">
