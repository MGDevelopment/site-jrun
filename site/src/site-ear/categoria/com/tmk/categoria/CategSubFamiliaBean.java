 ...
 *
 * $Log: CategSubFamiliaBean.java,v $
 * Revision 1.7  2003/12/04 17:18:57  GPistoia
 ...
 *
 * Revision 1.6  2003/10/03 16:28:48  GPistoia
...
public abstract class CategSubFamiliaBean implements EntityBean {
	...
	public CategSubFamiliaPK ejbCreate(Integer CATEGORIA_SECCION, Integer CATEGORIA_GRUPO, Integer CATEGORIA_FAMILIA, Integer CATEGORIA_SUBFAMILIA, String DESCRIPCION) throws CreateException {
	...
	public void ejbPostCreate(Integer CATEGORIA_SECCION, Integer CATEGORIA_GRUPO, Integer CATEGORIA_FAMILIA, Integer CATEGORIA_SUBFAMILIA, String DESCRIPCION) {
	}
