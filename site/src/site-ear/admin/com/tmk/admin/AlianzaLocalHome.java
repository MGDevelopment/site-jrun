 ...
 *
 * $Log: AlianzaLocalHome.java,v $
 * Revision 1.8  2006/02/09 16:15:33  omsartori
 ...
 *
 * Revision 1.7  2006/01/31 15:51:24  oDZurita
 ...
 *
 * Revision 1.6  2004/02/11 19:32:42  GPistoia
 * Buscador Nuevos
 * Mejoras en algunas paginas de reportes, conversion, simbolos, etc.
 *
 * Revision 1.5  2004/02/03 03:03:30  NRodriguez
 * - nueva extranet. Se agrego findByUsuario
 *
 ...
 *
 * Revision 1.3  2003/11/11 14:31:35  JMembrives
 * agregado del campo PORC_COMISION_PARTICULAR en alta y modificacion.
 *
 * Revision 1.2  2003/10/14 08:31:22  SLizardo
 * no message
 *
 */
...
public interface AlianzaLocalHome extends EJBLocalHome {

	public AlianzaLocal create(Integer ID_ALIANZA, String RAZON_SOCIAL, String URL, String TIPO_NEGOCIO, String CUIT, String USUARIO, String CLAVE, Integer ID_TIPO_CONTRIBUYENTE, String NOMBRE_CONTACTO, String APELLIDO_CONTACTO, String CARGO_CONTACTO, String NOMBRE_PAGO_COMISION, String APELLIDO_PAGO_COMISION, String E_MAIL_1, String E_MAIL_2, String TIPO_COMISION, Double PORC_COMISION_PARTICULAR) throws CreateException;

	public AlianzaLocal findByPrimaryKey(Integer pk) throws FinderException;

	public AlianzaLocal findByUsuarioClave(String USUARIO, String CLAVE) throws FinderException;

	public AlianzaLocal findByUsuario(String USUARIO) throws FinderException;

	public Collection findAll() throws FinderException;

    /*socio-alianza*/
//    public AlianzaLocal findBySocio(Integer ID_SOCIO) throws FinderException;
    /*socio-alianza*/
}