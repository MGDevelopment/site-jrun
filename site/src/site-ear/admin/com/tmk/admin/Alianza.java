 ...
 *
 * Revision 1.6  2006/01/31 15:51:23  oDZurita
 ...
 *
 * Revision 1.3  2003/12/04 17:18:33  GPistoia
 ...
 *
 * Revision 1.1  2003/10/11 17:53:43  SLizardo
 * no message
 *
 * Revision 1.5  2003/09/01 15:33:40  SLizardo
 * Administracion de Alianzas.
 *
 * Revision 1.4  2003/08/25 18:22:39  SLizardo
 * no message
 *
 * Revision 1.3  2003/08/15 15:58:49  GPistoia
 ...
 *
 * Revision 1.2  2003/07/25 16:03:55  SLizardo
 * *** empty log message ***
 *
 */
...
public interface Alianza extends EJBObject {
	...
	public String getTIPO_NEGOCIO() throws RemoteException;

	public void setTIPO_NEGOCIO(String TIPO_NEGOCIO) throws RemoteException;
	...
	public String getNOMBRE_CONTACTO() throws RemoteException;

	public void setNOMBRE_CONTACTO(String NOMBRE_CONTACTO) throws RemoteException;

	public String getAPELLIDO_CONTACTO() throws RemoteException;

	public void setAPELLIDO_CONTACTO(String APELLIDO_CONTACTO) throws RemoteException;

	public String getCARGO_CONTACTO() throws RemoteException;

	public void setCARGO_CONTACTO(String CARGO_CONTACTO) throws RemoteException;

	public String getNOMBRE_PAGO_COMISION() throws RemoteException;

	public void setNOMBRE_PAGO_COMISION(String NOMBRE_PAGO_COMISION) throws RemoteException;

	public String getAPELLIDO_PAGO_COMISION() throws RemoteException;

	public void setAPELLIDO_PAGO_COMISION(String APELLIDO_PAGO_COMISION) throws RemoteException;

	public String getE_MAIL_1() throws RemoteException;

	public void setE_MAIL_1(String E_MAIL_1) throws RemoteException;

	public String getE_MAIL_2() throws RemoteException;

	public void setE_MAIL_2(String E_MAIL_2) throws RemoteException;

	public String getTIPO_COMISION() throws RemoteException;

	public void setTIPO_COMISION(String TIPO_COMISION) throws RemoteException;

	public Date getFECHA_BAJA() throws RemoteException;

	public void setFECHA_BAJA(Date FECHA_BAJA) throws RemoteException;

	public Double getPORC_COMISION_PARTICULAR() throws RemoteException;

	public void setPORC_COMISION_PARTICULAR(Double PORC_COMISION_PARTICULAR) throws RemoteException;
