...
public abstract class FuncionBean implements EntityBean {
	...
	public String ejbCreate(String FUNCION, Integer ESTADO, java.sql.Timestamp FECHA_ALTA, String USUARIO_ALTA, java.sql.Timestamp FECHA_MODIF, String USUARIO_MODIF) throws CreateException {
		setFUNCION(FUNCION);
		setESTADO(ESTADO);
	...
	public void ejbPostCreate(String FUNCION, Integer ESTADO, java.sql.Timestamp FECHA_ALTA, String USUARIO_ALTA, java.sql.Timestamp FECHA_MODIF, String USUARIO_MODIF) {
	}
