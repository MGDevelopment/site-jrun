...
public class CriterioDAO {
	...
	private Comparator<DBO> comparador;

	public CriterioDAO(Integer clave, String descripcion, String columna, boolean ascendente, boolean mejorarTitulo, Comparator<DBO> comparador) {
		this.clave = clave;
	 ...
	 * @param comparador
	 */
	public CriterioDAO(Integer clave, String descripcion, String columna, boolean ascendente, boolean mejorarTitulo, String addSelect, String addFrom, String addWhere, String addFromJoin, Comparator<DBO> comparador) {
		this (clave, descripcion, columna, ascendente, mejorarTitulo, comparador);
	...
	/***
	 * busca por la clave y toma del <b>BuscadorHelper.criterios[clave]</b> los datos que necesita para llenar
	 * los atributos del CriterioDAO
	 * @param Integer clave 
	 */
	public CriterioDAO(Integer clave) {
		for (int i=0; i<BuscadorHelper.criterios.length; i++) {
			if (BuscadorHelper.criterios[i].clave.equals(clave)) {
				...
				this.comparador = BuscadorHelper.criterios[i].comparador;
			}
	...
	public Comparator<DBO> getComparador() {
		return comparador;
	}
