...
public class GenerarArticulo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String respuesta = "";
		String errorMsg = "<error><msg>Se produjo un error al intentar generar el articulo. Contacte al administrador.</msg></error>";
		String successMsg = "<success><msg>Se ha generado con exito el articulo: ID de Articulo " + idArticulo + "</msg></success>";
		...
		cabecera.append(this.getClass().getName()).append("(idArticulo=").append(idArticulo).append(", idSeccion=").append(idSeccion).append(")]");
			...
			try {
				boolean retorno = GeneradorDeArticulo.generarDetalle(Convert.toNumber(idArticulo, 0)
