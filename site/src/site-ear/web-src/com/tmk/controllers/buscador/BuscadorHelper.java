...
//    public static final String PAGINA_ATRIBUTOS_DINAMICOS = "/BusquedaAvanzadaAtributosDinamicos";
	...
	public static final CriterioDAO CRIT_ALFAB_AZ = new CriterioDAO(new Integer(0), "Alfabéticamente (de la 'A' la 'Z')", "titulo", true, false);
	public static final CriterioDAO CRIT_ALFAB_ZA = new CriterioDAO(new Integer(1), "Alfabéticamente (de la 'Z' la 'A')", "titulo", false, false);

	public static final CriterioDAO CRIT_FECHA_NV = new CriterioDAO(new Integer(2), "Por Fecha de Aparición (los más recientes primero)", "fecha_alta", false, true);
	public static final CriterioDAO CRIT_FECHA_VN = new CriterioDAO(new Integer(3), "Por Fecha de Aparición (los más antiguos primero)", "fecha_alta", true, true);

	public static final CriterioDAO CRIT_PRECIO_EC = new CriterioDAO(new Integer(4), "Por Precio de venta (los más económicos primero)", "precio", true, true,
			...
			"		/ 100,0)),2) precio", "", "", "");
	public static final CriterioDAO CRIT_PRECIO_CE = new CriterioDAO(new Integer(5), "Por Precio de venta (los más costosos primero)", "precio_venta_vigente", false, true,
			" ,ROUND (precio_venta_vigente * ( 1" +
			"		+ NVL (  (SELECT   NVL (tasa_general, 0)" +
			"		+ NVL (tasa_adicional, 0)" +
			"		+ NVL (tasa_percep_video, 0)" +
	...
	//public static final CriterioDAO CRIT_MAS_VENDIDOS = new CriterioDAO(new Integer(6), "Los Más Vendidos", "orden", true, true, ",mvs.orden", " LEFT JOIN mas_vendidos_seccion mvs ON a.id_articulo = mvs.id_articulo", "");

	public static final CriterioDAO CRIT_MAS_VENDIDOS = new CriterioDAO(new Integer(6), "Los Más Vendidos", "orden", true, true, ",mvs.orden", ",mas_vendidos_seccion mvs", "AND a.id_articulo = mvs.id_articulo(+)", " LEFT JOIN mas_vendidos_seccion mvs ON a.id_articulo = mvs.id_articulo");
