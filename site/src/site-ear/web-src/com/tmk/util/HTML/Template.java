...
package com.tmk.util.HTML;
import java.util.*;
import java.io.*;
import com.tmk.util.HTML.Tmpl.Element.*;
import com.tmk.util.HTML.Tmpl.Parsers.*;
import com.tmk.util.HTML.Tmpl.Util;
import com.tmk.util.HTML.Tmpl.Filter;
...
public class Template 
{
	...
	/**
	 * Agregados para evitar el acceso excesivo a disco.
	 * @param array
	 * @throws FileNotFoundException
	 * @throws IllegalStateException
	 * @throws IOException
	 */
	public Template(String[] array) throws FileNotFoundException, IllegalStateException, IOException {
		this.array = array;
		init2();
	}	
	private void init2() throws FileNotFoundException, IllegalStateException,
			IOException {
		//Util.debug = this.debug;
		params.put("__template__", "true");

		String[] parser_params = { "case_sensitive", stringify(case_sensitive),
				"strict", stringify(strict), "loop_context_vars",
				stringify(loop_context_vars), "global_vars",
				stringify(global_vars) };
	...
	private void read_file() throws FileNotFoundException,
			IllegalStateException, IOException, EmptyStackException {
