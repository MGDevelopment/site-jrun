...
*/
public class DesencriptarByteArrayWrapperConverter implements SingleValueConverter {
	...
	public String toString(Object array) {
		byte [] loginDesencriptado = CryptUtil.desEncriptar(((ByteArrayWarpper)array).getArray());
		try{
	...
	public boolean canConvert(Class type) {
		return (type.equals(ByteArrayWarpper.class));
	}
