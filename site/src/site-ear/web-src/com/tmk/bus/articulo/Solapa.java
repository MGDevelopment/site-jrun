...
import com.tmk.bus.fk.SolapaFK;
import com.tmk.dbo.DBO;

public class Solapa extends DBO {
	private static final SolapaFK cls_fk = SolapaFK.getInstance();
	...
	public static String getFiltro() {
		...
		filtro.append(getAlias()).append(".tipo(+) = '").append("17").append("'");
		filtro.append(" and ");
